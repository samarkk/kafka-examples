...
public class UEEApp {
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "ueapp");
        ...
        GlobalKTable<String, String> usersGlobalTable = builder.globalTable("usert");

        // we get a stream of user purchases
        KStream<String, String> userPurchases = builder.stream("userp");
        ...
        userPurchasesEnrichedJoin.to("upeij");
        ...
        userPurchasesEnrichedLeftJoin.to("upelj");
