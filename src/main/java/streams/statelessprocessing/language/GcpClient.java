    ...
    public List<EntitySentiment> getEntitySentiment(Tweet tweet) {
        ...
        try {
            ...
            for (Entity entity : response.getEntitiesList()) {
                ...
                entitySentiment.setEntity(entity.getName());
                entitySentiment.setText(tweet.getText());
                entitySentiment.setSalience((double) entity.getSalience());
                entitySentiment.setSentimentScore((double) sentiment.getScore());
                entitySentiment.setSentimentMagnitude((double) sentiment.getMagnitude());
