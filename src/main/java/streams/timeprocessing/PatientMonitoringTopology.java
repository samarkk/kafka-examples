...
import streams.timeprocessing.serialization.json.JsonSerdes;
...
class PatientMonitoringTopology {
    ...
    public static Topology build() {
        ...
        //  Add an extra explicit TimestampExtractor field to Consumerd
        ...
        // Add TimestampExtractor to Body Events also
